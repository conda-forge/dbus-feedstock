...
Package license: AFL-2.1 OR GPL-2.0-or-later

Summary: Simple message bus system for applications to talk to one another

Development: https://gitlab.freedesktop.org/dbus/dbus
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/dbus-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dbus-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `dbus` available on your platform:
...
```
pixi search dbus --channel conda-forge
```
